        ...
        <template
                    ...
                    <div class="lists-box"
                        ...
                        <div class="p-box">
                            ...
                            <div>
                                ...
                                <i class="el-icon-upload2 right-icon"
                                    v-if="!item.status"
                                    @click.stop="submitItem(item.nodeCode)"></i>
            ...
            <el-submenu
                    ...
                    <template slot="title">
                        ...
                        <i class="el-icon-plus right-btn"
                            @click.stop="setTwoData(item1.nodeCode)"></i>

                        <i class="el-icon-delete del-btn"></i>
                    </template>
                    ...
                    <template v-for="(item2, index2) in item1.children">
                        ...
                        <el-submenu
                            ...
                            <template slot="title">
                                ...
                                <i class="el-icon-plus right-btn"
                                    @click.stop="setData(item1.nodeCode, item2.nodeCode)"></i>
                                    ...
                                    <div class="lists-box"
                                        ...
                                        <div class="p-box">
                                            ...
                                            <div>
                                                <i class="el-icon-upload2 right-icon"
                                                    v-if="!item3.status"
                                                    @click.stop="submitItem(item3.nodeCode)"></i>

                                                <i class="el-icon-delete del-icon"
                                                    v-if="!item3.status"
                                                    @click.stop="delItem(item3.nodeCode)"></i>
                                            </div>
                                        </div>
                                    </div>
                            </el-menu-item>
