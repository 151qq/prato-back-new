    ...
    <div class="form-b">
        <el-collapse v-model="activeNames" @change="collChange">
          <el-collapse-item class="formStylePro" title="产品管理" name="0">
            <div class="left">
              <a class="xj-box">产品下架</a>
              <a class="pl-box">关闭评论</a>
              <a class="cg-box">草稿删除</a>
            </div>
            <div class="right">
              产品状态
              <span>草稿</span>
          ...
          <el-collapse-item class="formStylePro" title="物业基本信息" name="1">
          ...
          <div class="line-bold"></div>
          <el-collapse-item class="formStylePro" title="物业交易历史" name="2">
          ...
          <div class="line-bold"></div>
          <el-collapse-item class="formStylePro" title="物业租金历史" name="3">
          ...
          <div class="line-bold"></div>
          <el-collapse-item class="formStylePro editShow" title="物业评述" name="4">
          ...
          <div class="line-bold"></div>
          <el-collapse-item class="formStylePro" title="物业外观图片" name="5">
          ...
          <div class="line-bold"></div>
          <el-collapse-item class="formStylePro" title="物业公共区域图片" name="6">
          ...
          <div class="line-bold"></div>
          <el-collapse-item class="formStylePro" title="物业周围环境图片" name="7">
