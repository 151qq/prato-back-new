<template>
  <div class="allBoxA">
    ...
    <el-menu :default-active="activeName" :default-openeds="openeds" class="el-menu-vertical-demo">
      <el-submenu 
        ...
        <el-submenu class="two-box"
          ...
          <template slot="title">
            {{item2.label}}
            <span @click.stop="setData(item1.nodeCode, item2.nodeCode, item2.marketType)" class="add-box">
            +
            </span>
          </template>
          ...
          <el-menu-item
              ...
              :index="index1 + '-' + index2 + '-' + index3">
                ...
                <div class="lists-box"
                    ...
                    @click="getInfo(item3.nodeCode, item2.nodeCode, item2.marketType)">
    ...
    <add-market :is-add="isAdd" :add-data="addData" @addSucess="reLoadList"></add-market>
        ...
        util.request({
          ...
          if (this.treeData[0].children.length && this.treeData[0].children[0].children.length && !this.$route.params.code) {
            ...
            var data = {
              ...
              type: this.treeData[0].children[0].marketType
            }
