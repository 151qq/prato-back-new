            ...
            <el-collapse-item class="float-form-box" title="服务管理" name="3">
              <div class="formDiscount">
                <template v-for="(item, index) in productEventList">
                  <section class="formBox">
                      <span class="font-b">{{item.productCname}}</span>
                  </section>
                  <section class="formBox">
                      <span>Agent ID</span>
                      <el-input
                  ...
                  <section class="formBox">
                      <div class="btn-right-box">
                        <el-tooltip class="item" effect="dark" :content="item.priceDesc" placement="top">
                          <el-button>服务费用说明</el-button>
                        </el-tooltip>
                        
                        <el-button class="btn-right" type="primary" size="small">开通</el-button>
                      </div>
                  </section>
                </template>
    ...
    methods: {
        ...
        getBase () {
          util.request({
              ...
              if (res.result.success == '1') {
                  ...
                  if (this.base.enterpriseType == 'enterprise_type_0') {
        ...
        getProductAndEvent () {
          util.request({
              ...
              data: {
                enterpriseCode: this.$route.query.enterpriseData
              }
          }).then((res) => {
              if (res.result.success == '1') {
              ...
              if (res.result.success == '1') {
                  ...
                  if (this.$route.query.enterpriseCode) {
                    ...
                    var pathUrl = {
                      ...
                      query: {
                        enterpriseCode: res.result.result
                      }
                    }
