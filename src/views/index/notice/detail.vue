  ...
  methods: {
    getDetail () {
      ...
      util.request({
        ...
        this.detail = res.result.datas.detail
        this.vouchers = res.result.datas.vouchers
        this.gifts = res.result.datas.gifts
        this.zhes = res.result.datas.zhes
        this.author = res.result.datas.author
      })
    }
  },
  components: {
